        ...
        <i18n-tree :root="root" class="my-12 cm-flex-1" @nodeClick="onNodeClick">
          <template v-slot:default="slotProps">
            <div class="cm-flex cm-ai-center">
              ...
              <template v-if="!slotProps.node?.children.length  && slotProps.data?.hasWarnings()">
                <svg class="warning" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
