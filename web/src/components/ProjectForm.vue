<template>
  <div class="cm-card p-12">
    <div class="cm-card-header" v-if="project">
    ...
    <div class="cm-card-content">
      <form  class="cm-form">
        ...
        <div class="cm-field">
          ...
          <div class="cm-flex">
            <input class="cm-input cm-flex-1 mr-4" ref="language-input" placeholder="Type name of language" @keypress.enter="onAddLanguageClick">
    ...
    <!--      <i class="trigger not-primary-language" v-if="!language.isPrimary" title="Make primary" @click.prevent="onStarClick(language)"></i>-->
    <!--      <i class="trigger primary-language" type="warning" v-if="language.isPrimary"></i>-->
          {{ language.iso }}

          <svg class="delete-language" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" @click="onDeleteLanguageClick(language)">
        ...
        <div class="cm-flex">
          <button type="button" class="cm-button icon outline" @click="$router.push('/projects')">
            <svg class="cm-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
